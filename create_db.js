...
db.serialize(() => {
  ...
  db.run("CREATE TABLE request_info (uid INTEGER PRIMARY KEY, requester TEXT, emergency TEXT, category TEXT, disability TEXT, description TEXT, latitude FLOAT, longitude FLOAT, status TEXT, accepter TEXT)");
